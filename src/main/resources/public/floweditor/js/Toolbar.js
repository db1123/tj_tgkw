...
Toolbar.prototype.init = function()
{
  ...
  if (sw >= 700)
  {
    var elts = this.addItems(['view', '-']);
		elts[0].setAttribute('title', mxResources.get('view') + ' (' + this.editorUi.actions.get('view').shortcut + ')');
  }
...
Toolbar.prototype.addItems = function(keys, c, ignoreDisabled)
{
    ...
    {
      items.push(this.addItem('geSprite-formatpanel', key, c, ignoreDisabled));
    }
    else
		{
