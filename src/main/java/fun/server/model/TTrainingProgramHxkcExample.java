...
public class TTrainingProgramHxkcExample {
     ...
     * @mbg.generated
     */
    public TTrainingProgramHxkcExample() {
    ...
    /**
     * TTrainingProgramHxkc
     * GeneratedCriteria
     * 数据库表：student_capability_evaluation..t_training_program_hxkc
     */
